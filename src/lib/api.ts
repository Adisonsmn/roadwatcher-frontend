...
console.log('🔧 [API Debug] API_BASE_URL being used:', API_BASE_URL)
console.log('🔧 [API Debug] Raw import.meta.env.VITE_API_BASE_URL:', import.meta.env.VITE_API_BASE_URL)
